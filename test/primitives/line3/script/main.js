...
function main() {
	...
	scene.onLoad.addOnce(function () {
		...
		// 点
		lib.primitives.line(surface.renderer(), 50, 50, 50, 50, rgba);

		// 水平線
		lib.primitives.line(surface.renderer(), 100, 50, 150, 50, rgba);

		// 垂直線
		lib.primitives.line(surface.renderer(), 50, 100, 50, 150, rgba);
